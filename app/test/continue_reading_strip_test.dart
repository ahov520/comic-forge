...
void main() {
  ...
  Finder gridText(String text) => find.descendant(
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(stripText(serial.name), findsOneWidget);
      expect(find.descendant(of: strip(), matching: find.byType(BookCover)),
          findsNWidgets(2));
