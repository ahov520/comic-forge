...
void main() {
  ...
  testWidgets('本地备份入口仅 Android 显示，非 Android 不出现', (tester) async {
    await _showSettings(tester, state, platform: TargetPlatform.linux);
  ...
  testWidgets('Android 导出可分享或保存，导入可选择合并或覆盖', (tester) async {
    String? sharedName;
    String? savedName;
    var imported = false;
    state.sources.add(
